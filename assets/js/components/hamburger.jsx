    ...
    return (
      <div style={styles.screen} onClick={this.closeMenu}>
        <div style={styles.menu}>
          <div style={styles.candidate.name}>
            {window.name}
          </div>
          <div style={styles.candidate.district}>
            {window.district}
          </div>
...
const siteMap = [
  ...
  { text: 'Events', action: () => scrollTo('#events') },
  { text: 'News', action: () => scrollTo('#news') },
  {
    text: 'Volunteer',
    action: () => scrollTo('#volunteer'),
    extraStyles: {
      borderBottom: '3px solid white',
      color: 'white'
    }
